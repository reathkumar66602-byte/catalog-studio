...
export function listingFieldValues(listing: MappedListing): Record<string, string> {
  ...
  const pairs: Array<[string[], string | undefined]> = [
    ...
    [["importer name"], listing.manufacturerPincode || listing.packerPincode ? "Not Required" : ""],
    [["importer address"], listing.manufacturerPincode || listing.packerPincode ? "Not Required" : ""],
    [["importer pincode"], listing.manufacturerPincode || listing.packerPincode ? "Not Required" : ""],
